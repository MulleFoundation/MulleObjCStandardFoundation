...
# Disable for this platform: `mulle-sourcetree mark MulleObjCContainerFoundation no-cmake-platform-darwin`
#
if( NOT MULLE_OBJC_CONTAINER_FOUNDATION_LIBRARY)
   find_library( MULLE_OBJC_CONTAINER_FOUNDATION_LIBRARY NAMES ${CMAKE_STATIC_LIBRARY_PREFIX}MulleObjCContainerFoundation${CMAKE_STATIC_LIBRARY_SUFFIX} MulleObjCContainerFoundation NO_CMAKE_SYSTEM_PATH NO_SYSTEM_ENVIRONMENT_PATH)
   ...
   if( MULLE_OBJC_CONTAINER_FOUNDATION_LIBRARY)
      ...
      #
      # Append header directory to user search path.
      # Disable with: `mulle-sourcetree mark MulleObjCContainerFoundation no-cmake-searchpath`
      #
      foreach( _TMP_MULLE_OBJC_CONTAINER_FOUNDATION_NAME "MulleObjCContainerFoundation")
         set( _TMP_MULLE_OBJC_CONTAINER_FOUNDATION_DIR "${_TMP_MULLE_OBJC_CONTAINER_FOUNDATION_ROOT}/include/${_TMP_MULLE_OBJC_CONTAINER_FOUNDATION_NAME}")
         if( IS_DIRECTORY "${_TMP_MULLE_OBJC_CONTAINER_FOUNDATION_DIR}")
            set( INHERITED_INCLUDE_DIRS
               ${INHERITED_INCLUDE_DIRS}
               "${_TMP_MULLE_OBJC_CONTAINER_FOUNDATION_DIR}"
               CACHE INTERNAL "need to cache this"
            )
            break()
         else()
