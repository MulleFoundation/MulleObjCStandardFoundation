...
#if defined( MULLE_OBJC_STANDARD_FOUNDATION_BUILD) || defined( MULLE_FOUNDATION_BASE_BUILD)
# define MULLE_OBJC_STANDARD_FOUNDATION_GLOBAL    MULLE_C_GLOBAL
#else
# if defined( MULLE_OBJC_STANDARD_FOUNDATION_INCLUDE_DYNAMIC) || (defined( MULLE_INCLUDE_DYNAMIC) && ! defined( MULLE_OBJC_STANDARD_FOUNDATION_INCLUDE_STATIC))
#  define MULLE_OBJC_STANDARD_FOUNDATION_GLOBAL   MULLE_C_EXTERN_GLOBAL
# else
#  define MULLE_OBJC_STANDARD_FOUNDATION_GLOBAL   extern
# endif
#endif
